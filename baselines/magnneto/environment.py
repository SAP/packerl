"""
Implementation of the network environment used in MAGNNETO.
"""
...
class Environment(object):
    ...
    ****************************************************************************
    ...
    def get_link_probs(self):
        ...
        node_p_in = list(traffic_in / np.sum(traffic_in) if np.sum(traffic_in) > 0 else traffic_in)
        node_p_out = list(traffic_out / np.sum(traffic_out) if np.sum(traffic_out) > 0 else traffic_out)
